...
import os
import tfe_keeper.train_and_predict_lr as train_and_predict_lr
import platform
...
class TestBinning(TestCase):
    ...
    def test_run(self, run):
        ...
        train_and_predict_lr.run(taskId="qqq", conf=self.conf, modelFileMachine="YOwner",
                                 modelFilePath=modelFilePath, modelFilePlainTextPath=modelFilePlainTextPath)
